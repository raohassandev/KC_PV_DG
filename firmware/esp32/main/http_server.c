...
static esp_err_t telemetry_snapshot_get(httpd_req_t *req) {
  ...
  cJSON_AddNumberToObject(out, "gridL1ReactivePowerVar", have_em ? em.l1_reactive_power_var : 0.0);
  cJSON_AddNumberToObject(out, "gridL2ReactivePowerVar", have_em ? em.l2_reactive_power_var : 0.0);
  cJSON_AddNumberToObject(out, "gridL3ReactivePowerVar", have_em ? em.l3_reactive_power_var : 0.0);
  cJSON_AddNumberToObject(out, "gridL1ApparentPowerVa", have_em ? em.l1_apparent_power_va : 0.0);
  cJSON_AddNumberToObject(out, "gridL2ApparentPowerVa", have_em ? em.l2_apparent_power_va : 0.0);
  cJSON_AddNumberToObject(out, "gridL3ApparentPowerVa", have_em ? em.l3_apparent_power_va : 0.0);
  cJSON_AddNumberToObject(out, "gridL1Pf", have_em ? em.l1_pf : 0.0);
  cJSON_AddNumberToObject(out, "gridL2Pf", have_em ? em.l2_pf : 0.0);
  cJSON_AddNumberToObject(out, "gridL3Pf", have_em ? em.l3_pf : 0.0);
  ...
  cJSON_AddNumberToObject(out, "gridImportKwhT1", have_em ? em.import_kwh_t1 : 0.0);
  cJSON_AddNumberToObject(out, "gridExportKwhT1", have_em ? em.export_kwh_t1 : 0.0);
  cJSON_AddNumberToObject(out, "gridImportKwhT2", have_em ? em.import_kwh_t2 : 0.0);
  cJSON_AddNumberToObject(out, "gridExportKwhT2", have_em ? em.export_kwh_t2 : 0.0);
